...
class getStorefrontControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/OrderPizzaRepository.php';
        ...
        $container->services['App\\Controller\\StorefrontController'] = $instance = new \App\Controller\StorefrontController(($container->privates['App\\Service\\UserService'] ?? $container->load('getUserServiceService')), ($container->privates['App\\Service\\ImageService'] ?? ($container->privates['App\\Service\\ImageService'] = new \App\Service\ImageService())), new \App\Service\PizzaService($b, new \App\Repository\PizzaIngredientRepository($a), new \App\Repository\IngredientRepository($a)), new \App\Service\OrderService(new \App\Repository\OrderRepository($a), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), $b, new \App\Repository\OrderPizzaRepository($a)), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));
