 ...
 */
final class Version20240612204848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pizza_ingredient (pizza_id INT NOT NULL, ingredient_id INT NOT NULL, count_of_ingredient INT NOT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX pizzaid_ingredientid (pizza_id, ingredient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
