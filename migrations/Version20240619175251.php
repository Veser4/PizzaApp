 ...
 */
final class Version20240619175251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_order ADD userId INT DEFAULT NULL, DROP user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_order ADD user_id INT NOT NULL, DROP userId');
    }
}
