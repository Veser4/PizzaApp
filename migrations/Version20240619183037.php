 ...
 */
final class Version20240619183037 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_order ADD CONSTRAINT FK_23FA1E55A76ED395 FOREIGN KEY (user_id) REFERENCES user (user_id) ON UPDATE NO ACTION ON DELETE NO ACTION');
